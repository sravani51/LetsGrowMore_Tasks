...
import javax.swing.ButtonGroup;
    ...
    public class Task3 {
        ...
        private void initialize() {
            ...
            JLabel labelNewLabel = new JLabel("SCIENTIFIC CALCULATOR");
            labelNewLabel.setFont(new Font("Arial Black", Font.BOLD, 30));
            labelNewLabel.setBounds(106, 10, 481, 23);
            frame.getContentPane().add(labelNewLabel);
